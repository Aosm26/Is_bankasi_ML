...
data=pd.read_csv('hazir_hundred.csv')
...
#        data.loc[a, label] = data.loc[a,label2]
#        print(label)
#    a+=1
# data = data.fillna(0)
# # Verisetini kaydedin
...
y = data.menus.values.reshape(-1,1)
print(x.shape)
print(y.shape)
...
print(x_train.shape)
print(y_train.shape)
model.add(tf.keras.layers.Dense(256, input_shape=(50,), activation='sigmoid'))
